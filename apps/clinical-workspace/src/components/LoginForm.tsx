...
export function LoginForm({ surfaceLabel }: { surfaceLabel: string }) {
  ...
  return (
    <SpotlightCard className="w-full max-w-md p-8">
      <p className="text-center text-[11px] font-bold uppercase tracking-[0.18em] text-sky-300">
        Clinical Desk
      </p>
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-5">
        <label className="block text-xs font-bold uppercase tracking-wide text-ihs-muted">
          ...
          <input
            ...
            className="mt-2 w-full rounded-xl border border-white/10 bg-black/35 px-3 py-3 uppercase text-ihs-text outline-none transition-colors focus:border-sky-400/50"
            value={uid}
        ...
        <label className="block text-xs font-bold uppercase tracking-wide text-ihs-muted">
          ...
          <input
            ...
            placeholder="••••••"
            className="mt-2 w-full rounded-xl border border-white/10 bg-black/35 px-3 py-3 text-center tracking-[0.4em] text-ihs-text outline-none transition-colors focus:border-sky-400/50"
            value={pin}
        ...
        <SpringButton
          type="submit"
          disabled={!canSubmit}
          className="w-full rounded-xl bg-ihs-info px-4 py-3 text-sm font-bold uppercase tracking-widest text-white disabled:cursor-not-allowed disabled:bg-ihs-elevated disabled:text-ihs-muted"
        >
