      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-5">
        <label className="block text-xs font-bold uppercase tracking-wide text-ihs-muted">
          ...
          <input
            ...
            className="mt-2 w-full rounded-xl border border-ihs-border bg-ihs-elevated px-3 py-3 uppercase text-ihs-text outline-none focus:border-ihs-info"
            value={uid}
        ...
        <label className="block text-xs font-bold uppercase tracking-wide text-ihs-muted">
          ...
          <input
            ...
            placeholder="••••••"
            className="mt-2 w-full rounded-xl border border-ihs-border bg-ihs-elevated px-3 py-3 text-center tracking-[0.4em] text-ihs-text outline-none focus:border-ihs-info"
            value={pin}
        ...
        <button
          type="submit"
          disabled={!canSubmit}
          className="ios-press w-full rounded-xl bg-ihs-info px-4 py-3 text-sm font-bold uppercase tracking-widest text-white disabled:cursor-not-allowed disabled:bg-ihs-elevated disabled:text-ihs-muted"
        >
